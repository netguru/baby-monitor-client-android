...
import co.netguru.baby.monitor.client.feature.analytics.AnalyticsManager.Companion.PERMISSION_MICROPHONE

class PermissionMicrophoneFragment : BaseFragment() {
    override val layoutResource = R.layout.fragment_microphone_permission
    override val screenName: String = PERMISSION_MICROPHONE
