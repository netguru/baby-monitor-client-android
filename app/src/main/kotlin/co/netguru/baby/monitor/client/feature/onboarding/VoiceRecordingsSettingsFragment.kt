...
import co.netguru.baby.monitor.client.feature.analytics.AnalyticsManager.Companion.VOICE_RECORDINGS_SETTING
...
class VoiceRecordingsSettingsFragment : BaseFragment() {
    ...
    override val screenName: String = VOICE_RECORDINGS_SETTING
